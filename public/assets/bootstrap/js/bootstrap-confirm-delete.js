;( function ( $, window, document, undefined )
{
    var bootstrap_confirm_delete = function ( element, options )
    {
        ...
        this.onDelete = function ( event )
        {
            ...
            {
                $( 'body' ).append( '<div id="bootstrap-confirm-delete-container">\n\
<div id="bootstrap-confirm-dialog" class="modal fade">\n\
<div class="modal-dialog modal-sm"><div class="modal-content">\n\
<div class="modal-header"><button type="button" class="close" data-dismiss="modal">\n\
<span aria-hidden="true">&times;</span>\n\
<span class="sr-only">Close</span>\n\
</button>\n\
<h4 id="bootstrap-confirm-dialog-heading"></h4>\n\
</div><div class="modal-footer">\n\
<button id="bootstrap-confirm-dialog-cancel-delete-btn" type="button" class="btn btn-default pull-left" data-dismiss="modal">Cancel</button>\n\
<a id="bootstrap-confirm-dialog-delete-btn" href="#" class="btn btn-danger pull-right">Delete</a>\n\
</div></div></div></div></div>' );
            }
