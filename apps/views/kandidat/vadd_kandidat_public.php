<form  action="<?php echo base_url(); ?>entry-data?token=<?php echo $token ?>&key=<?php echo $key ?>" method="post" enctype="multipart/form-data">
    <!-- left column --> 
            ...
            <div class="box-body">
                ...
                <div class="form-group">
                    ...
                    <div class="radio">
                        ...
                        <label>
                            <input type="radio" class="minimal-red" name="gol_darah" id="radio2" value="B">
                            B
                        </label>
                        <label>
    ...
    <section class="col-md-6 connectedSortable">
                ...
                <div class="form-group">
                    <div class="radio" >
                       ...
                       <br> 
                        ...
                        <label><input type="radio" name="penyakit" onclick="show1();" value="Tidak" >Tidak</label>
            ...
            <div class="box-body">
                <table>
                    ...
                    <tr>
                        ...
                        <td><input type="text" class="form-control docs-date" name="tanggal_lulus[]" placeholder="Lulus">
                        </td>
                        <input type="text" class="form-control" hidden style="display: none" name="tingkat_sekolah[]" value="SD">
                    </tr>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control docs-date" name="tanggal_lulus[]" placeholder="Lulus">
                        </td><input type="text" class="form-control" style="display: none" hidden name="tingkat_sekolah[]" value="SMA">
                    </tr>
                    <tr>
                        ...
                        <td>
                            <input type="text" class="form-control docs-date" name="tanggal_lulus[]" placeholder="Lulus">
                        </td><input type="text" class="form-control" style="display: none" hidden name="tingkat_sekolah[]" value="S1">
                    </tr>
                    <tr>
                        <td>Pasca Sarjana</td>
                        <td><input type="text" name="nama_sekolah[]" class="form-control" placeholder="Nama Sekolah ..."></td>
                        ...
                        <td>
                            <input type="text" class="form-control docs-date" name="tanggal_lulus[]" placeholder="Lulus">
                        </td><input type="text" class="form-control" style="display: none" hidden name="tingkat_sekolah[]" value="S2">
                    </tr>
                </table>                     
            </div>
            <!-- /.box-body -->
        ...
        <div class="box box-warning" >
            ...
            <div class="control-group">
                ...
                <div class="box-body">
                    <div class="col-md-9">
                    <select class="form-control" name="kota_id" id="sc_show_kota" > 
...
<div >
    ...
    <label for="a-0">Data yang saya isi diatas adalah benar - benar data saya </label>
